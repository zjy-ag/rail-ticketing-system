    ...
    function build_orders_table(result) {
        ...
        $.each(orders, function (index, item) {
            var content = '<td class="check-mail">\n' +
                ...
                '                            </td>\n' +
                '                            <td class="mail-ontact"><a href="maildetail.html">'+item.fromUser+'</a><span class="label label-warning pull-right">好友分享</span>\n' +
                '                            </td>\n' +
                '                            <td class="mail-subject"><a href="maildetail.html">'+item.content+'</a>\n' +
                '                            </td>\n' +
